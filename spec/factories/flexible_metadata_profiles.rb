...
FactoryBot.define do
  ...
  factory :flexible_metadata_class, class: FlexibleMetadata::ProfileClass do
    name            { "Image" }
  ...
  factory :flexible_metadata_context, class: FlexibleMetadata::ProfileContext do
    name            { "flexible_context" }
    display_label   { "Flexible Context" }
    context_texts { [FactoryBot.build(:flexible_metadata_text_for_context)] }
  end

  factory :flexible_metadata_property, class: FlexibleMetadata::ProfileProperty do
    name            { "title" }
  ...
  factory :flexible_metadata_text, class: FlexibleMetadata::ProfileText do
    name { "display_label" }
    value { "Title" }
  end

  factory :flexible_metadata_text_for_class, class: FlexibleMetadata::ProfileText do
    name            { "display_label" }
    value           { "Title in Class" }
  end

  factory :flexible_metadata_text_for_context, class: FlexibleMetadata::ProfileText do
    name            { "display_label" }
