...
FactoryBot.define do
  factory :m3_profile, class: FlexibleMetadata::Profile do
  ...
  factory :m3_profile_class, class: FlexibleMetadata::ProfileClass do
    name            { "Image" }
  ...
  factory :m3_profile_context, class: FlexibleMetadata::ProfileContext do
    name            { "flexible_context" }
    display_label   { "Flexible Context" }
    context_texts { [FactoryBot.build(:m3_profile_text_for_context)] }
  end

  factory :m3_profile_property, class: FlexibleMetadata::ProfileProperty do
    name            { "title" }
  ...
  factory :m3_profile_text, class: FlexibleMetadata::ProfileText do
    name { "display_label" }
    value { "Title" }
  end

  factory :m3_profile_text_for_class, class: FlexibleMetadata::ProfileText do
    name            { "display_label" }
    value           { "Title in Class" }
  end

  factory :m3_profile_text_for_context, class: FlexibleMetadata::ProfileText do
    name            { "display_label" }
