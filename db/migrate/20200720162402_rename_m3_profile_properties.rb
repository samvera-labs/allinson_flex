class RenameM3ProfileProperties < ActiveRecord::Migration[5.1]
  def change
    ...
    remove_index :allinson_flex_profile_available_properties, :m3_profile_property_id
    rename_column :allinson_flex_profile_available_properties, :m3_profile_property_id, :allinson_flex_profile_property_id
    add_index :allinson_flex_profile_available_properties, :allinson_flex_profile_property_id, name: :allinson_flex_profile_available_properties_property_id
