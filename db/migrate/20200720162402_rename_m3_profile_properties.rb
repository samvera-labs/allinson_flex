class RenameM3ProfileProperties < ActiveRecord::Migration[5.1]
  def change
    ...
    add_index :flexible_metadata_available_properties, :m3_profile_property_id, name: :flexible_metadata_available_properties_property_id
    ...
    add_index :m3_profile_texts, :m3_profile_property_id, name: :flexible_metadata_profile_texts_on_profile_property_id
  end
end
