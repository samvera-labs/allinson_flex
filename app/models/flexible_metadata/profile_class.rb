...
module FlexibleMetadata
  class ProfileClass < ApplicationRecord
    ...
    has_and_belongs_to_many :contexts, class_name: 'FlexibleMetadata::ProfileContext', foreign_key: 'm3_profile_class_id', association_foreign_key: 'm3_profile_context_id'
